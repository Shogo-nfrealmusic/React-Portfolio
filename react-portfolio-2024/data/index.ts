...
export const gridItems = [
  {
    id: 1,
    title: "My major is law at a Japanese university, but I'm currently studying CS in the United States.",
    description: "",
  ...
  {
    id: 4,
    title: "Tech learner with a passion for development.",
    description: "",
  ...
  {
    id: 5,
    title: "Currently building a Python Django Website",
    description: "",
  ...
  {
    id: 6,
    title: "Are you interested in SHOGO KIKUCHI?",
    description: "",
    className: "lg:col-span-2 md:col-span-3 md:row-span-1",
    imgClassName: "",
...
export const workExperience = [
  ...
  },
  {
    id: 2,
    title: "CS experience",
    desc: "Studied in Seattle, USA for 1 year as CS major",
    className: "md:col-span-2", 
    thumbnail: "/exp2.svg",
  },
  {
    id: 3,
    title: "Co-development with friends",
  ...
  },
  {
    ...
    desc: "I quickly incorporate new technologies into my capabilities.",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
  },
];
