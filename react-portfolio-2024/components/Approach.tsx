  ...
  return (
    <section className="w-full py-20" id="approach">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        des="I am trying to catch up by learning more every day for my short engineering experience. I also try to increase my efficiency by adopting the latest technologies instantly."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        des="I spend most of my day writing code, including self-study, lectures, and internships."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        des="My unmatched perspicacity coupled with my sheer indefatigability makes me a feared opponent in any realm of human endeavour."
        >
          <CanvasRevealEffect
            animationSpeed={3}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        <h2 className="dark:text-white opacity-0 group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4  font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition duration-20 text-center text-3xl">
          {title}
        </h2>
